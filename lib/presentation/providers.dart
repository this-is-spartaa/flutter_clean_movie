...
import 'package:flutter_clean_movie/data/data_source/tmbd_movie_data_source_impl.dart';
import 'package:flutter_clean_movie/data/repository/movie_repository_impl.dart';
...
import 'package:flutter_clean_movie/domain/usecase/fetch_top_rated_movies_usecase.dart';
import 'package:flutter_clean_movie/domain/usecase/fetch_upcoming_movies_usecase.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

final _movieDataSourceProvider = Provider<MovieDataSource>((ref) {
  return TmbdMovieDataSourceImpl(Dio(BaseOptions(
